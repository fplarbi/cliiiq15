...
export async function createMessage(recipientUserId: string, data: MessageSchema):
    ...
    try {
        ...
        await pusherServer.trigger(createChartId(userId, recipientUserId), 'message:new', messageDto);
...
export async function getMessageThread(recipientId: string) {
    try {
        ...
        if (messages.length > 0) {
            ...
            await pusherServer.trigger(createChartId(recipientId, userId), 'messages:read', readMessageIds)
        }
